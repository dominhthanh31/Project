...
<main>
    ...
    <div class="" id="banner">
        ...
        <div class="container">
           <div class="colum__3">
               <div class="colum__01 title__colum--border">
                   <div class="colum__img">
                       <a href="customer01.php" class="colum__imgs">
                           <img src="asstes/img/a1.png" alt="">
                       </a>
                   </div>
                    <div class="">
                        <h2 class="colum--title"><a href="">Pay insurance premiums online with Dai-ichi Connect App</a></h2>
                        <p class="colum__title">You access the Dai-ichi Connect App. Select [...]</p>
                    </div>
               </div>

                <div class="colum__01 title__colum--border">
                    <div class="colum__img">
                        <a href="customer02.php" class="colum__imgs">
                            <img src="asstes/img/a2.png" alt="">
                        </a>
                    </div>
                    <h2 class="colum--title"><a href="">Guide to paying premiums for Dai-ichi Life Vietnam</a></h2>
                    <p class="colum__title">In order to create convenience and more options for customers to pay premium [...]</p>
                </div>

                <div class="colum__01 title__colum--border">
                    <div class="colum__img">
                        <a href="customer03.php" class="colum__imgs">
                            <img src="asstes/img/a3.png " alt="" style="height: -200px;">
                        </a>
                    </div>
                    <h2 class="colum--title"><a href="">Settlement of insurance benefits for Dai-ichi Life health care card</a></h2>
                    <p class="colum__title">With only simple steps and necessary documents [...]</p>
                </div>
           </div>
        </div>
   </div> 
